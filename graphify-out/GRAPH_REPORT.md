...
## Corpus Check
- 346 files · ~174,279 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2382 nodes · 6359 edges · 224 communities detected
- Extraction: 47% EXTRACTED · 53% INFERRED · 0% AMBIGUOUS · INFERRED: 3395 edges (avg confidence: 0.72)
...
6. `TranscriptToken` - 55 edges
7. `TranscriptSentence` - 55 edges
8. `testDB()` - 53 edges
9. `NormalizedClipData` - 52 edges
10. `Queries` - 50 edges
...
Cohesion: 0.02
Nodes (117): insertItemsWithQueries(), insertRunWithQueries(), appendUniqueInt64(), appendUniqueString(), firstValidEndQuizItem(), groupEndQuizCandidates(), mapEndQuizCandidate(), nonBlankStringPointer() (+109 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (98): Options, Principal, principalContextKey, TestPrincipalMiddlewareDoesNotFallbackWhenGatewayHeaderIsMalformed(), TestPrincipalMiddlewareFallsBackToAuthorizationInDevMode(), TestPrincipalMiddlewareIgnoresAuthorizationOutsideDevMode(), TestPrincipalMiddlewareInjectsGatewayUserinfoPrincipal(), TestPrincipalMiddlewareRejectsMalformedAuthorizationFallback() (+90 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (95): stateRow, TestDefaultAuditWriterSkipsItemInsertForEmptyItems(), TestDefaultAuditWriterWritesItemsInOneRepositoryCall(), NewDefaultAuditWriter(), NewDefaultExplanationBuilder(), NewDefaultServingStateManager(), NewDefaultVideoStateEnricher(), failingAuditWriter (+87 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (94): BodyLimit(), New(), decodeJSON(), newServer(), postJSON(), readBody(), TestEndQuizMapsErrors(), TestEndQuizRejectsInvalidTransportRequest() (+86 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (91): NewEndQuizQuestionLookupUsecase(), candidate(), TestEndQuizQuestionLookupPrefersVideoContextAndFallsBackToGeneric(), TestEndQuizQuestionLookupPropagatesReaderError(), TestEndQuizQuestionLookupRejectsInvalidRequestAndMissingVideo(), validPayload(), hasCode(), IsConflictError() (+83 more)
...
Cohesion: 0.04
Nodes (66): IsAffectsProgressEffect(), isJSONObject(), IsObserveOnlyEffect(), IsPassingQuality(), IsSetMasteredEffect(), IsSupportedEventType(), IsSupportedReducerEffect(), ValidateEvent() (+58 more)
...
Cohesion: 0.06
Nodes (65): appendUnique(), containsVideo(), filterCandidatesByLane(), orderedDistinctVideos(), recommendableRow(), recommendationContext(), recommendationDemand(), summarizeCandidates() (+57 more)
...
Cohesion: 0.11
Nodes (29): bestSpanKey(), int32Key(), int64Key(), NewDefaultEvidenceResolver(), resolveBestBounds(), resolvedSpans(), resolveWindowBounds(), resolveWindowSentenceIndexes() (+21 more)
...
## Knowledge Gaps
- **390 isolated node(s):** `DATABASE_URL Loader`, `moduleSpec`, `config`, `candidateSummary`, `execer` (+385 more)
...
- **Why does `New()` connect `Community 4` to `Community 1`, `Community 3`, `Community 5`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 12`, `Community 18`?**
  _High betweenness centrality (0.084) - this node is a cross-community bridge._
- **Why does `run()` connect `Community 4` to `Community 0`, `Community 1`, `Community 3`, `Community 5`, `Community 8`, `Community 12`, `Community 15`, `Community 28`?**
...
- **Are the 73 inferred relationships involving `New()` (e.g. with `buildHTTPHandler()` and `run()`) actually correct?**
  _`New()` has 73 INFERRED edges - model-reasoned connections that need verification._
...
- **Are the 53 inferred relationships involving `TranscriptSemanticElement` (e.g. with `CatalogIngestAlignmentTest` and `_FakeCursor`) actually correct?**
  _`TranscriptSemanticElement` has 53 INFERRED edges - model-reasoned connections that need verification._