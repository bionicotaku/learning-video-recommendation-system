...
import (
	...
	infra "learning-video-recommendation-system/internal/recommendation/infrastructure"
	repopkg "learning-video-recommendation-system/internal/recommendation/infrastructure/persistence/repository"
	"learning-video-recommendation-system/internal/recommendation/infrastructure/persistence/sqlcgen"
	txtx "learning-video-recommendation-system/internal/recommendation/infrastructure/persistence/tx"
...
func newGenerateUseCase(pool *pgxpool.Pool, querier sqlcgen.Querier) usecase.GenerateLearningUnitRecommendationsUseCase {
	return usecase.NewGenerateLearningUnitRecommendationsUseCase(
		...
		repopkg.NewUserUnitStateReadRepository(querier),
