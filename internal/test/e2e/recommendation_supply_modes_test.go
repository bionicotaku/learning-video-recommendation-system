	...
	h.SeedCatalogVideo(t, bundleVideo(
		...
		[]testutil.VideoUnitIndexFixture{
			...
			},
			{
				...
				BestEvidenceSentenceIndex: 2,
				BestEvidenceSpanIndex:     0,
			},
		},
		[]testutil.SemanticSpanFixture{
			{SentenceIndex: 0, SpanIndex: 0, CoarseUnitID: &hardUnit, StartMs: 1_200, EndMs: 2_300},
			{SentenceIndex: 2, SpanIndex: 0, CoarseUnitID: &newUnit, StartMs: 4_200, EndMs: 5_300},
		},
		[]testutil.TranscriptSentenceFixture{
			{SentenceIndex: 0, StartMs: 1_200, EndMs: 2_300},
			{SentenceIndex: 1, StartMs: 2_400, EndMs: 3_200},
			{SentenceIndex: 2, StartMs: 4_200, EndMs: 5_300},
		},
		120_000,
		0.88,
	))
...
func TestE2E_RecommendationLowSupplyModePreservesCoreCoverage(t *testing.T) {
	...
	h.SeedCatalogVideo(t, bundleVideo(
		...
		[]testutil.SemanticSpanFixture{
			{SentenceIndex: 0, SpanIndex: 0, CoarseUnitID: &hardUnit, StartMs: 1_200, EndMs: 2_100},
			{SentenceIndex: 2, SpanIndex: 0, CoarseUnitID: &softUnitB, StartMs: 4_000, EndMs: 5_000},
		},
		[]testutil.TranscriptSentenceFixture{
			{SentenceIndex: 0, StartMs: 1_200, EndMs: 2_100},
			{SentenceIndex: 1, StartMs: 2_200, EndMs: 3_200},
			{SentenceIndex: 2, StartMs: 4_000, EndMs: 5_000},
		},
		110_000,
		0.72,
	))
