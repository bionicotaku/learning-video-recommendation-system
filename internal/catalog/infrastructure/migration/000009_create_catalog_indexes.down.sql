...
drop index if exists catalog.idx_videos_recommendable;
drop index if exists catalog.idx_video_unit_index_video_id;
drop index if exists catalog.idx_video_unit_index_unit_video;
drop index if exists catalog.idx_video_unit_index_coarse_unit_mention_coverage;
drop index if exists catalog.idx_video_semantic_spans_unit_video_start;
