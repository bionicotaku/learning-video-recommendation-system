...
func TestVideoPresentationReaderListFeedVideosByIDs(t *testing.T) {
	...
	reader := catalogrepo.NewVideoPresentationReader(db.Pool)
...
func TestVideoPresentationReaderGetVideoDetailByID(t *testing.T) {
	db := suite.CreateTestDatabase(t)
	ctx := context.Background()
...
func TestUnitLabelReaderListUnitLabelsByIDs(t *testing.T) {
	db := suite.CreateTestDatabase(t)
	ctx := context.Background()
	...
	reader := catalogrepo.NewUnitLabelReader(db.Pool)
