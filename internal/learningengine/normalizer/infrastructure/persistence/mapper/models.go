...
func ToRawQuizEventByID(row normalizersqlc.ListQuizEventsByIDsRow) model.RawQuizEvent {
	return model.RawQuizEvent{
		EventID:             UUIDToString(row.EventID),
		UserID:              UUIDToString(row.UserID),
		QuestionID:          UUIDToString(row.QuestionID),
...
func ToRawLearningInteractionByID(row normalizersqlc.ListLearningInteractionsByIDsRow) model.RawLearningInteraction {
	return model.RawLearningInteraction{
		EventID:                        UUIDToString(row.EventID),
		UserID:                         UUIDToString(row.UserID),
		EventType:                      row.EventType,
