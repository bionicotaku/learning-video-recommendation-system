...
func OpenSuite() (*Suite, error) {
	inner, err := pgtest.OpenSuite(pgtest.Options{
		TempDirPrefix:        "learningengine-normalizer-integration-*",
		TemplateDatabaseName: "learningengine_normalizer_template",
		DatabaseNamePrefix:   "learningengine_normalizer_test",
